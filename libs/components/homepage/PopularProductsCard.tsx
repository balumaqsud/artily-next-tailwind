...
const PopularProductsCard = ({
  ...
  return (
    <div className="w-[360px] rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-1000 ease-in-out hover:scale-105 hover:shadow-md dark:border-gray-200 dark:bg-neutral-200 cursor-pointer">
      <div
        role="button"
